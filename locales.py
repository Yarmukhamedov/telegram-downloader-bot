...
MESSAGES = {
    ...
    "help_text": {
        ...
        "ru": (
            ...
            "   • 📸 Instagram (Reels и Видео)\n"
            "   • 🧵 Threads (Публикации и Видео)\n"
            "   • 📌 Pinterest (Видео и GIF)\n"
            "   • 🐦 Twitter / X (Видео)\n\n"
            "2. *Как скачивать?*\n"
    ...
    "buy_premium_text": {
        "uz": (
            ...
            "• *Yuqori Tezlikdagi Oqim:* Premium serverlar yordamida navbatsiz tezkor yuklash\n"
            "• *Reklamasiz Muhit:* Hech qanday reklama yoki homiy xabarlarisiz\n\n"
            "*Shartlar:* Xaridlar 100% xavfsiz tarzda *Telegram Stars* orqali amalga oshiriladi. Obunangiz muddatini istalgan vaqtda uzaytirishingiz mumkin."
        ),
        "ru": (
            "*⭐ Подписка Premium*\n\n"
            "*Что вы получаете с Premium?*\n"
            "• *Безлимитные скачивания:* Никаких суточных ограничений\n"
            "• *Максимальное качество:* Доступ к скачиванию в 1080p Full HD и 4K Ultra HD\n"
            "• *Приоритетная скорость:* Загрузка без очередей на скорости Premium серверов\n"
            "• *Без рекламы:* Никакой рекламы или спонсорских сообщений\n\n"
            "*Условия:* Оплата 100% безопасно обрабатывается через *Telegram Stars*. Вы можете продлить подписку в любое время."
        ),
        "en": (
            ...
            "• *Priority High-Speed:* Bypass queues with Premium server speeds\n"
